...
{
    public class VixenSchedulerModule : AppModuleInstanceBase
    {
        ...
        {
            VixenSystem.Logs.AddLog(new VixenSchedulerLog());
            _AddApplicationMenu();
            _SetEnableState(_data.IsEnabled);
            _synchronizationContext = SynchronizationContext.Current;

            VixenSystem.Logging.Schedule("Vixen Scheduler module loaded.");
        }
        ...
        private void _AddApplicationMenu()
        {
            ...
            {
                var cmdRoot = new AppCommand(ID_ROOT, "Vixen Scheduler");

                var cmdEnabled = new LatchedAppCommand("VixenSchedulerEnabled", "Enabled");
                ...
                var cmdShow = new AppCommand("VixenSchedulerShow", "Schedule");
        ...
        public override void Unloading()
        {
            ...
            VixenSystem.Logging.Schedule("Vixen Scheduler module unloaded.");
